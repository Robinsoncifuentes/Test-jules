    ...
    <nav className="bg-gray-900 text-white p-4 shadow-lg fixed w-full top-0 z-50">
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        <div className="text-2xl font-bold">
          <a href="#home">MySite</a> {/* Simple text logo */}
        </div>
        ...
        >
          {/* Icon (simple three lines for hamburger) */}
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} w-full md:flex md:items-center md:w-auto pt-4 md:pt-0`}>
          <ul className="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0 text-lg">
            <li>
              <a href="#home" className="hover:text-blue-400 transition-colors duration-300 block py-2 md:py-0" onClick={() => isOpen && setIsOpen(false)}>Home</a>
            </li>
            <li>
              <a href="#about" className="hover:text-blue-400 transition-colors duration-300 block py-2 md:py-0" onClick={() => isOpen && setIsOpen(false)}>About</a>
            </li>
            <li>
              <a href="#contact" className="hover:text-blue-400 transition-colors duration-300 block py-2 md:py-0" onClick={() => isOpen && setIsOpen(false)}>Contact</a>
            </li>
          </ul>
        </div>
      </div>
